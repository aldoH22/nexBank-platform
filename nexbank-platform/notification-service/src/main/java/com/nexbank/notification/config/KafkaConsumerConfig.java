package com.nexbank.notification.config;
...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, TransactionEvent> transactionConsumerFactory() {
        ...
        deserializer.addTrustedPackages("com.nexbank.common.event");
    ...
    @Bean
    public ConsumerFactory<String, LoanEvent> loanConsumerFactory() {
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, LoanEvent>
            loanKafkaListenerContainerFactory() {
